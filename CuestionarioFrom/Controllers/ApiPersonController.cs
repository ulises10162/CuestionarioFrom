...
using CuestionarioFrom.Data;
using CuestionarioFrom.Models;

namespace CuestionarioFrom.Controllers
{
    public class ApiPersonController : Controller
    {
        ...
        // GET: ApiPerson/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ApiPerson/Create
